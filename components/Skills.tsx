    ...
    <section id="skills" className={`w-full py-20 bg-transparent"}`}>
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col items-center justify-between mb-10">
          <h2 className={`text-3xl text-center md:text-4xl font-extrabold mb-2 ${isDarkMode ? "text-white" : "text-black"}`}>
            {t("Skills")}
          </h2>
          <p className={`text-sm text-center ${isDarkMode ? "text-slate-300" : "text-slate-700"}`}>
